class MainController:
    ...
    def start(self) -> None:
        ...
        last_playlist = self.settings_controller.get_setting(
            "last_playlist_path", ""
        ) or self.settings_controller.get_setting("last_playlist", "")
        last_playlist_is_url = (
            str(self.settings_controller.get_setting("last_playlist_is_url", "false")).strip().lower()
        )
